...
function get_botblocker_ipv4_rules_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');

    global $wpdb;
    $table_name = $wpdb->prefix . BOTBLOCKER_TABLE_PREFIX . 'ipv4rules';
...
add_action('wp_ajax_get_botblocker_ipv4_rules', 'get_botblocker_ipv4_rules_callback');

function delete_ipv4_rule_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
...
add_action('wp_ajax_delete_ipv4_rule', 'delete_ipv4_rule_callback');

function toggle_ipv4_rule_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
    ...
    if ($result !== false) {
        ...
        wp_send_json_error('Failed to toggle IPv4 rule');
    }
}
add_action('wp_ajax_toggle_ipv4_rule', 'toggle_ipv4_rule_callback');

function create_ipv4_rule_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
    ...
    $data = array(
        ...
        'search' => $ip,
        'ip1' => bbcs_ipToNumeric($ip_range[0]),
        'ip2' => bbcs_ipToNumeric($ip_range[1]),
...
add_action('wp_ajax_create_ipv4_rule', 'create_ipv4_rule_callback');

function update_ipv4_rule_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
...
add_action('wp_ajax_update_ipv4_rule', 'update_ipv4_rule_callback');

function export_ipv4_rules_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
...
add_action('wp_ajax_export_ipv4_rules', 'export_ipv4_rules_callback');

function import_ipv4_rules_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
...
add_action('wp_ajax_import_ipv4_rules', 'import_ipv4_rules_callback');

function clear_all_ipv4_rules_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
...
add_action('wp_ajax_clear_all_ipv4_rules', 'clear_all_ipv4_rules_callback');

function get_ipv4_rule_details_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
...
add_action('wp_ajax_get_ipv4_rule_details', 'get_ipv4_rule_details_callback');

function import_ipv4_whitelist_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
    import_ipv4_list('allow');
}
add_action('wp_ajax_import_ipv4_whitelist', 'import_ipv4_whitelist_callback');

function import_ipv4_blacklist_callback()
{
    check_ajax_referer('botblocker_nonce', 'nonce');
    import_ipv4_list('block');
}
add_action('wp_ajax_import_ipv4_blacklist', 'import_ipv4_blacklist_callback');

function import_ipv4_list($rule_type)
{
    global $wpdb;
    $table_name = $wpdb->prefix . BOTBLOCKER_TABLE_PREFIX . 'ipv4rules';
